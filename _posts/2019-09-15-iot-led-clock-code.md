---
layout: single
title: Code for convertible IOT Matrix
author_profile: false
comments: false
---


Software Prototype V1
----------

For the software im using [MD_PAROLA](https://github.com/MajicDesigns/MD_Parola) library running on an Arduino ESP32, this library makes it easy to manage the two displays, since by default it works by creating zones out of the available LED Matrixes, in this case we use 2 zones.
